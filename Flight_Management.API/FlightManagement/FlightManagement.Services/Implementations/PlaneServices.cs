...
namespace FlightManagement.Services.Implementations
{
    public class PlaneServices : IPlaneServices
    {
        ...
        public async Task<planeUpdateRepose> UpdatePlane(int id, PlaneUpdateRequest PlaneRequest)
        {
            if (id > 0)
            {
                ...
                if (diArrivalAirport != null)
                {
                    ...
                    var planeResponse = new planeUpdateRepose
                    {
                        Id = plane.Id,
