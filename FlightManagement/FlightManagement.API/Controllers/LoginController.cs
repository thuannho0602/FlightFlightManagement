...
namespace FlightManagement.API.Controllers
{
    ...
    public class LoginController : BaseController
    {
        ...
        public LoginController(UserManager<User> userManager, IUserServices userServices, IConfiguration configuration, RoleManager<IdentityRole<Guid>> roleManager)
        {
        ...
        public async Task<IActionResult>CreateUser(UserCreatRequest newUserDTO)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (!await _userManager.IsInRoleAsync(newUser, newUserDTO.Role))
                {
                   userResult=await _userManager.AddToRoleAsync(newUser, newUserDTO.Role);
                }
        ...
        private async Task<string> CreatedToken(User user)
        {
            ...
            var config = _configuration.GetSection("Jwt").Get<JwtTokenSetting>();
