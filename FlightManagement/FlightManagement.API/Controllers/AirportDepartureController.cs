...
namespace FlightManagement.API.Controllers
{
    ...
    public class AirportDepartureController : BaseController
    {
        ...
        [HttpPost]
        public async Task<AirportDepartureCreateRespone> Create(AirportDepartureCreateRequest airportDepartureCreateRequest)
        {
            return await _airportDepartureServices.CreateAirportDeparture(airportDepartureCreateRequest);
        }
        [HttpGet]
        public async Task<IEnumerable<AirportDepartureGetRespone>> GetAll()
        {
        ...
        [HttpPut("{Id}")]
        public async Task<AirportDepartureUpdateRespone> Update( int Id,AirportDepartureUpdateRequest airportDepartureUpdateRequest)
        {
