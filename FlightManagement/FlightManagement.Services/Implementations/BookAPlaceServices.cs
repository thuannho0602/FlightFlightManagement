...
namespace FlightManagement.Services.Implementations
{
    ...
    {
        private readonly IBookAPlaceRepository _bookAPlaceRepository;
        private readonly IHoldTheSeatRepository _holdTheSeatRepository;
        private readonly IClientRepository _clientRepository;
        private readonly ApplicationDbContext _appDbContext;
        public BookAPlaceServices(IBookAPlaceRepository bookAPlaceRepository, IClientRepository clientRepository, ApplicationDbContext appDbContext, IHoldTheSeatRepository holdTheSeatRepository)
        {
        ...
        public async Task<int> CreateClient(ClientCreateRequest client)
        {
            if(client != null)
            {
                ...
                _clientRepository.SaveChanges();
                return await Task<int>.FromResult(clientDb.Id);
            }
            return -1;
